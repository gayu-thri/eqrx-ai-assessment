...
from factory_intelligence.tools.productivity import get_productivity_kpi as _get_productivity_kpi
...
from factory_intelligence.tools.alarms import get_downtime_alarms as _get_downtime_alarms
...
@mcp.tool()
async def get_productivity_kpi(start_time: str, end_time: str,
                               line_id: int = None, equipment_id: int = None):
    """
...
# Tool #2: Quality KPI
@mcp.tool()
async def get_quality_kpi(start_time: str, end_time: str,
                          line_id: int = None, equipment_id: int = None):
    """
...
# Tool #3: Downtime KPI
@mcp.tool()
async def get_downtime_kpi(start_time: str, end_time: str,
                           line_id: int = None, equipment_id: int = None):
    """
...
@mcp.tool()
async def get_kpi_summary(start_time: str, end_time: str,
                          line_id: int = None, equipment_id: int = None):
    """
...
@mcp.tool()
async def get_downtime_alarms(start_time: str, end_time: str,
                              line_id: int = None, equipment_id: int = None):
    """
